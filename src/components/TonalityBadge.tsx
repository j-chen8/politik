...
export function TonalityBadge({ slug }: TonalityBadgeProps) {
  ...
  return (
    <TagInfoPopover
      ...
      color={colors.color}
      bg={colors.bg}
      glossarAnchor={`/glossar#tonalitaeten-reden-${slug.replace(/_/g, "-")}`}
      variant="tonalitaet"
    />
  );
}
...
export function RedenTypBadge({ code }: RedenTypBadgeProps) {
  ...
  return (
    <TagInfoPopover
      ...
      color="#52525b"
      bg="#f4f4f5"
      glossarAnchor={primary ? `/glossar#reden-typen-${primary}` : undefined}
      variant="redentyp"
    />
  );
}
...
export function DrucksacheTonalityBadge({ slug }: DrucksacheTonalityBadgeProps) {
  ...
  return (
    <TagInfoPopover
      ...
      color={colors.color}
      bg={colors.bg}
      glossarAnchor={`/glossar#tonalitaeten-drucksachen-${slug}`}
      variant="tonalitaet"
    />
  );
}
