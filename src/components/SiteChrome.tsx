...
import { Search, Radio, Activity, Users, Gavel, Vote, BookOpen, Library, ChevronDown, Menu, X } from "lucide-react";
...
// Analyse + Über existieren im landtag-Tree noch nicht (kommen mit dem master-Merge).
const MORE_NAV = [
          ...
          <nav aria-label="Hauptnavigation" className="hidden sm:flex items-center gap-0.5">
            ...
            <div className="relative" ref={moreRef}>
              ...
              {moreOpen && (
                <div
                  role="menu"
                  className="absolute right-0 top-full mt-1.5 min-w-[170px] rounded-lg border border-border-soft bg-white shadow-lg py-1"
                >
                  {MORE_NAV.map((item) => (
                    <Link
                      key={item.href}
