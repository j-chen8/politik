        ...
        <section className="mb-14">
          ...
          <div className="space-y-4 text-[15.5px] text-zinc-700 leading-relaxed">
            ...
            <p>
              ...
              <Link href="/design/linear/methodik" className="text-zinc-950 underline underline-offset-4 decoration-zinc-300 hover:decoration-zinc-950 transition-colors">
                Methodik-Seite
              </Link>
              .
            </p>
        ...
        <section className="mb-14">
          ...
          <div className="space-y-4 text-[15.5px] text-zinc-700 leading-relaxed">
            ...
            <p>
              ...
              <Link href="/design/linear/impressum" className="text-zinc-950 underline underline-offset-4 decoration-zinc-300 hover:decoration-zinc-950 transition-colors">
                Impressum
              </Link>
