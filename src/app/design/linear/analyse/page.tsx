      ...
      <div className="max-w-4xl mx-auto px-5 py-12 fade-in-up">
        ...
        <section className="mb-16">
          ...
          <CaveatBox>
            ...
            <Link
              href="/design/linear/methodik#tonalitaet-caveats"
              className="text-[#1a3e72] hover:underline underline-offset-2"
            >
              Methodik-Seite
            </Link>
        ...
        <section className="mb-16">
          ...
          <CaveatBox>
            ...
            <Link
              href="/design/linear/glossar#tonalitaeten-drucksachen"
              className="text-[#1a3e72] hover:underline underline-offset-2"
            >
              Glossar
            </Link>
...
function GlossarLink({ slug, variant = "reden", children }: GlossarLinkProps) {
  ...
  return (
    <Link
      href={`/design/linear/glossar#${anchor}`}
