      ...
      <div className="max-w-5xl mx-auto px-5 py-12 fade-in-up">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            ...
            <Link
              href="/design/linear/methodik#plenarbeitrag-typen"
        ...
        <div className="mb-8 flex flex-wrap gap-1.5">
          {Object.entries(PLENAR_TYPE_SLUG_LABEL).map(([s, lbl]) => (
            <Link
              key={s}
              href={`/design/linear/protokolle/typ/${s}`}
              ...
              >
                <div className="flex items-start justify-between gap-3 flex-wrap mb-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    <Link
                      href={`/design/linear/protokolle/redner/${encodeURIComponent(r.speaker)}`}
        ...
        {totalPages > 1 && (
          <div className="mt-8 flex items-center justify-between text-[12px]">
            ...
            <div className="flex gap-2">
              {page > 1 && (
                <Link
                  href={`/design/linear/protokolle/typ/${slug}?page=${page - 1}`}
