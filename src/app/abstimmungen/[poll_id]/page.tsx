          ...
          <section className="mb-10 fade-in-up fade-in-up-2">
            ...
            <div className="border border-zinc-200/70 rounded-2xl bg-white px-5 py-5">
              ...
              <div className="mt-4 pt-3 border-t border-zinc-100 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-zinc-400">
                ...
                <span className="text-zinc-300">·</span>
                <Link href="/methodik" className="hover:text-zinc-600 transition-colors underline decoration-zinc-300">
                  Methodik
                </Link>
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-1.5">
                    {drillVoters.map((v, idx) => (
                      <div key={`${v.politician_id ?? "x"}-${idx}`} className="text-[13px]">
                        {v.politician_id ? (
                          <Link href={`/politiker/${v.politician_id}`} className="text-zinc-900 hover:underline">
          ...
          <section className="mb-10 fade-in-up fade-in-up-3">
            ...
            <div className="space-y-2">
              {drucksachen.map((d) => (
                <div
                  key={d.drucksache_nr}
                  className="border border-zinc-200/70 rounded-xl bg-white overflow-hidden hover:border-zinc-300 transition-colors"
                >
                  <Link
                  ...
                  {d.pdf_url && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener"
                      className="flex items-center gap-1.5 border-t border-zinc-100 px-5 py-2.5 text-[11.5px] font-medium text-[#1a3e72] hover:bg-[#1a3e72]/[0.04] transition-colors"
                    >
