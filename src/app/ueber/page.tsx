  ...
  return (
    <div className="page-wash min-h-screen">
      <div className="max-w-2xl mx-auto px-5 pt-24 pb-24 fade-in-up">
        ...
        <p className="text-[17px] text-zinc-600 dark:text-zinc-300 leading-relaxed mb-14 max-w-xl">
        ...
        <section className="mb-14">
          ...
          <div className="space-y-4 text-[15.5px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            <p>
        ...
        <section className="mb-14">
          ...
          <div className="space-y-4 text-[15.5px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            <p>
              Ich heiße <strong className="text-zinc-950 dark:text-zinc-50">Jinsheng</strong>, lebe in Berlin, habe chinesische Wurzeln und arbeite an dieser Plattform seit dem Frühling 2026 — Solo, neben dem eigentlichen Leben her.
            </p>
            <p>
        ...
        <section className="mb-14">
          ...
          <div className="space-y-4 text-[15.5px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <p>
              Für die Seite selbst gilt eine <strong className="text-zinc-950 dark:text-zinc-50">Neutralitätspflicht</strong>. Methodische Regeln werden gleich auf alle Fraktionen angewendet. Tonalitäts-Klassifikationen beschreiben die rhetorische Form, nicht die inhaltliche Berechtigung — Details auf der{" "}
              <Link href="/methodik" className="text-zinc-950 dark:text-zinc-50 underline underline-offset-4 decoration-zinc-300 dark:decoration-zinc-600 hover:decoration-zinc-950 dark:hover:decoration-zinc-100 transition-colors">
                Methodik-Seite
              </Link>
              .
            </p>
        ...
        <section className="mb-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="rounded-2xl border border-border bg-card p-5">
              ...
              <ul className="space-y-1.5 text-[14px] text-zinc-700 dark:text-zinc-300 leading-snug">
        ...
        <section className="mb-14">
          ...
          <div className="space-y-4 text-[15.5px] text-zinc-700 dark:text-zinc-300 leading-relaxed">
            ...
            <p>
              Eine Spenden-Möglichkeit oder geeignete Förderstruktur folgt, sobald die rechtlichen Rahmen stehen. <strong className="text-zinc-950 dark:text-zinc-50">Methodische Unabhängigkeit ist Voraussetzung</strong> — egal woher eine Finanzierung käme. Wenn dir ein Fehler auffällt, melde ihn bitte per E-Mail über das{" "}
              <Link href="/impressum" className="text-zinc-950 dark:text-zinc-50 underline underline-offset-4 decoration-zinc-300 dark:decoration-zinc-600 hover:decoration-zinc-950 dark:hover:decoration-zinc-100 transition-colors">
                Impressum
              </Link>
        ...
        <section className="mb-14">
          ...
          <div className="rounded-2xl border border-border bg-card p-5">
            <p className="text-[15.5px] text-zinc-700 dark:text-zinc-300 leading-relaxed mb-3">
              <strong className="text-zinc-950 dark:text-zinc-50">Feedback. Feedback. Und nochmals Feedback.</strong> Nichts ist mir aktuell wichtiger als die Außensicht — von Menschen, die sich für Politik, Daten oder Methodik interessieren und mir sagen können, ob das, was ich hier mache, überhaupt der richtige Weg ist.
            </p>
            <p className="text-[14.5px] text-zinc-600 dark:text-zinc-300 leading-relaxed mb-2">
              Konkret hilfreich:
            </p>
            <ul className="space-y-1.5 text-[14.5px] text-zinc-700 dark:text-zinc-300 leading-snug mb-3 ml-1">
            ...
            <p className="text-[14.5px] text-zinc-600 dark:text-zinc-300 leading-relaxed">
        ...
        <section>
          ...
          <div className="space-y-2">
            <Link
              href="/methodik"
              className="flex items-center justify-between rounded-xl border border-border bg-card px-4 py-3 hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors group"
            >
              <div>
                <div className="text-[14.5px] font-medium text-zinc-950 dark:text-zinc-50">Methodik &amp; Wirksamkeit</div>
                <div className="text-[12.5px] text-zinc-500 dark:text-zinc-400">Pipeline, Modelle, bekannte Limitationen, Audit-Trail</div>
              </div>
            ...
            >
              <div>
                <div className="text-[14.5px] font-medium text-zinc-950 dark:text-zinc-50">Impressum &amp; Kontakt</div>
                <div className="text-[12.5px] text-zinc-500 dark:text-zinc-400">Pflichtangaben, Korrekturhinweise, Feedback-E-Mail</div>
              </div>
              <ArrowRight className="w-4 h-4 text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-950 dark:group-hover:text-zinc-50 transition-colors" strokeWidth={2.25} />
            </Link>
          </div>
