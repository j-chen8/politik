  ...
  return (
    <div className="page-wash min-h-screen">
      <div className="max-w-2xl mx-auto px-5 pt-24 pb-24 fade-in-up">
        ...
        <p className="text-[15px] text-zinc-500 dark:text-zinc-400 mb-12">
        ...
        <div className="space-y-12 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-2.5 text-zinc-700 dark:text-zinc-300">
              <li className="flex gap-3">
                <span className="text-zinc-300 dark:text-zinc-600 mt-2 shrink-0">━</span>
                <span><strong className="text-zinc-900 dark:text-zinc-100">Keine Parteifinanzierung.</strong> Keine Partei, keine Fraktion, keine parteinahe Stiftung, kein:e Bundestagsabgeordnete:r finanziert Politik-Radar — direkt oder indirekt.</span>
              </li>
              <li className="flex gap-3">
                <span className="text-zinc-300 dark:text-zinc-600 mt-2 shrink-0">━</span>
                <span><strong className="text-zinc-900 dark:text-zinc-100">Keine Konzernfinanzierung.</strong> Kein Unternehmen, kein Verband, keine PR-Agentur, kein Lobbybüro.</span>
              </li>
              <li className="flex gap-3">
                <span className="text-zinc-300 dark:text-zinc-600 mt-2 shrink-0">━</span>
                <span><strong className="text-zinc-900 dark:text-zinc-100">Keine bezahlten Inhalte.</strong> Keine Sponsored Posts, keine Affiliate-Links, kein „Native Advertising".</span>
              </li>
              <li className="flex gap-3">
                <span className="text-zinc-300 dark:text-zinc-600 mt-2 shrink-0">━</span>
                <span><strong className="text-zinc-900 dark:text-zinc-100">Keine Daten-Verkäufe.</strong> Daten werden nicht kommerziell weitergegeben oder verkauft.</span>
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-1.5 text-zinc-700 dark:text-zinc-300 ml-1 mb-4">
          ...
          <section>
            ...
            <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              Unternehmen, die strukturierten <strong className="text-zinc-900 dark:text-zinc-100">Vollzugriff auf die
              Datenbank</strong> benötigen, ist perspektivisch ein <strong className="text-zinc-900 dark:text-zinc-100">kostenpflichtiger API- bzw.
            ...
            <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              angewiesen ist. Der Zugang ist bewusst <strong className="text-zinc-900 dark:text-zinc-100">diskriminierungsfrei</strong>:
              Wer den Tarif bezahlt, bekommt die Daten — unabhängig von
              redaktioneller Linie, Parteinähe oder Berichterstattung über
              Politik-Radar.
            </p>
            <p className="text-zinc-700 dark:text-zinc-300">
              <strong className="text-zinc-900 dark:text-zinc-100">Wichtig:</strong> Datenzugang ist kein Einfluss auf
